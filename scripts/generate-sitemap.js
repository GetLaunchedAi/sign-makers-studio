...
// Configuration
const CONFIG = {
  baseUrl: 'https://signmakersstudio.com/',
  ...
  rules: {
    ...
    '/reviews/': { priority: '0.70', changefreq: 'monthly' },
    '/custom-signs-graphics/': { priority: '0.90', changefreq: 'monthly' },
    '/digital-display-solutions/': { priority: '0.90', changefreq: 'monthly' },
    '/vehicle-wraps-graphics/': { priority: '0.90', changefreq: 'monthly' },
    '/printing-promotional-products/': { priority: '0.90', changefreq: 'monthly' },
    ...
    try {
      ...
      for (const item of items) {
        ...
        if (stats.isDirectory()) {
          ...
          const url = pathToUrl(fullPath, publicDir).replace(/\\/g, '/');
